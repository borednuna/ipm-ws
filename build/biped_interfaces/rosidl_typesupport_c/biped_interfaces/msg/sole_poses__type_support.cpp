...
static const _SolePoses_type_support_symbol_names_t _SolePoses_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, biped_interfaces, msg, SolePoses)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, biped_interfaces, msg, SolePoses)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, biped_interfaces, msg, SolePoses)() {
  return &::biped_interfaces::msg::rosidl_typesupport_c::SolePoses_message_type_support_handle;
}
