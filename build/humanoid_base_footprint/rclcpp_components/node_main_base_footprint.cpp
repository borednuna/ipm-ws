...
#define NODE_MAIN_LOGGER_NAME "base_footprint"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbase_footprint_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<humanoid_base_footprint::BaseFootprintBroadcaster>";
