...
bool ipm_interfaces__srv__map_point__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ipm_interfaces.srv._map_point.MapPoint_Request", full_classname_dest, 46) == 0);
  }
  ipm_interfaces__srv__MapPoint_Request * ros_message = _ros_message;
  {  // plane
  ...
  {  // point
    ...
    if (!vision_msgs__msg__point2_d__convert_from_py(field, &ros_message->point)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * ipm_interfaces__srv__map_point__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ipm_interfaces.srv._map_point");
  ...
  {  // point
    PyObject * field = NULL;
    field = vision_msgs__msg__point2_d__convert_to_py(&ros_message->point);
    if (!field) {
      return NULL;
    }
    {
...
ROSIDL_GENERATOR_C_EXPORT
bool ipm_interfaces__srv__map_point__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ipm_interfaces.srv._map_point.MapPoint_Response", full_classname_dest, 47) == 0);
  }
  ipm_interfaces__srv__MapPoint_Response * ros_message = _ros_message;
  {  // point
    PyObject * field = PyObject_GetAttrString(_pymsg, "point");
    if (!field) {
      return false;
...
ROSIDL_GENERATOR_C_EXPORT
bool ipm_interfaces__srv__map_point__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ipm_interfaces.srv._map_point.MapPoint_Event", full_classname_dest, 44) == 0);
  }
  ipm_interfaces__srv__MapPoint_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!ipm_interfaces__srv__MapPoint_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ipm_interfaces__srv__MapPoint_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ipm_interfaces__srv__MapPoint_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ipm_interfaces__srv__map_point__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!ipm_interfaces__srv__MapPoint_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ipm_interfaces__srv__MapPoint_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ipm_interfaces__srv__MapPoint_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ipm_interfaces__srv__map_point__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of MapPoint_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ipm_interfaces.srv._map_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MapPoint_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ipm_interfaces__srv__map_point__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ipm_interfaces__srv__map_point__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
