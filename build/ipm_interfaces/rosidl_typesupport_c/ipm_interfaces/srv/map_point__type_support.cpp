...
static const _MapPoint_Request_type_support_symbol_names_t _MapPoint_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ipm_interfaces, srv, MapPoint_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ipm_interfaces, srv, MapPoint_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ipm_interfaces, srv, MapPoint_Request)() {
  return &::ipm_interfaces::srv::rosidl_typesupport_c::MapPoint_Request_message_type_support_handle;
}
...
static const _MapPoint_Response_type_support_symbol_names_t _MapPoint_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ipm_interfaces, srv, MapPoint_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ipm_interfaces, srv, MapPoint_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ipm_interfaces, srv, MapPoint_Response)() {
  return &::ipm_interfaces::srv::rosidl_typesupport_c::MapPoint_Response_message_type_support_handle;
}
...
static const _MapPoint_Event_type_support_symbol_names_t _MapPoint_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ipm_interfaces, srv, MapPoint_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ipm_interfaces, srv, MapPoint_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ipm_interfaces, srv, MapPoint_Event)() {
  return &::ipm_interfaces::srv::rosidl_typesupport_c::MapPoint_Event_message_type_support_handle;
}
...
static const _MapPoint_type_support_symbol_names_t _MapPoint_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ipm_interfaces, srv, MapPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ipm_interfaces, srv, MapPoint)),
  }
};
...
static const rosidl_service_type_support_t MapPoint_service_type_support_handle = {
  ...
  &MapPoint_Request_message_type_support_handle,
  &MapPoint_Response_message_type_support_handle,
  &MapPoint_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ipm_interfaces, srv, MapPoint)() {
  return &::ipm_interfaces::srv::rosidl_typesupport_c::MapPoint_service_type_support_handle;
}
