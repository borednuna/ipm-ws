...
bool vision_msgs__msg__object_hypothesis_with_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // hypothesis
    ...
    if (!vision_msgs__msg__object_hypothesis__convert_from_py(field, &ros_message->hypothesis)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * vision_msgs__msg__object_hypothesis_with_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {  // hypothesis
    PyObject * field = NULL;
    field = vision_msgs__msg__object_hypothesis__convert_to_py(&ros_message->hypothesis);
    if (!field) {
      return NULL;
    }
    {
