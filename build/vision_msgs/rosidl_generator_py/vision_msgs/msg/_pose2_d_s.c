...
bool vision_msgs__msg__pose2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._pose2_d.Pose2D", full_classname_dest, 31) == 0);
  }
  vision_msgs__msg__Pose2D * ros_message = _ros_message;
  {  // position
    PyObject * field = PyObject_GetAttrString(_pymsg, "position");
    if (!field) {
      return false;
    }
    if (!vision_msgs__msg__point2_d__convert_from_py(field, &ros_message->position)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * vision_msgs__msg__pose2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._pose2_d");
  ...
  {  // position
    PyObject * field = NULL;
    field = vision_msgs__msg__point2_d__convert_to_py(&ros_message->position);
    if (!field) {
      return NULL;
    }
    {
