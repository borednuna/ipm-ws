...
bool vision_msgs__msg__point2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._point2_d.Point2D", full_classname_dest, 33) == 0);
  }
  vision_msgs__msg__Point2D * ros_message = _ros_message;
  {  // x
...
PyObject * vision_msgs__msg__point2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._point2_d");
