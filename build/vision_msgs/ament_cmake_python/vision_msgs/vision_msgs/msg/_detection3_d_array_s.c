...
bool vision_msgs__msg__detection3_d_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._detection3_d_array.Detection3DArray", full_classname_dest, 52) == 0);
  }
  vision_msgs__msg__Detection3DArray * ros_message = _ros_message;
  {  // header
  ...
  {  // detections
    ...
    vision_msgs__msg__Detection3D * dest = ros_message->detections.data;
...
PyObject * vision_msgs__msg__detection3_d_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._detection3_d_array");
