...
#ifndef IPM_INTERFACES__SRV__DETAIL__MAP_POINT_CLOUD2__FUNCTIONS_H_
#define IPM_INTERFACES__SRV__DETAIL__MAP_POINT_CLOUD2__FUNCTIONS_H_
...
/// Initialize srv/MapPointCloud2 message.
/**
...
/// Finalize srv/MapPointCloud2 message.
/**
...
/// Create srv/MapPointCloud2 message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ipm_interfaces__srv__MapPointCloud2_Request__init().
...
/// Destroy srv/MapPointCloud2 message.
/**
 * It calls
 * ipm_interfaces__srv__MapPointCloud2_Request__fini()
...
/// Check for srv/MapPointCloud2 message equality.
/**
...
/// Copy a srv/MapPointCloud2 message.
/**
...
/// Initialize array of srv/MapPointCloud2 messages.
/**
...
/// Finalize array of srv/MapPointCloud2 messages.
/**
 * It calls
 * ipm_interfaces__srv__MapPointCloud2_Request__fini()
...
/// Create array of srv/MapPointCloud2 messages.
/**
...
/// Destroy array of srv/MapPointCloud2 messages.
/**
 * It calls
 * ipm_interfaces__srv__MapPointCloud2_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MapPointCloud2 message array equality.
/**
...
/// Copy an array of srv/MapPointCloud2 messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ipm_interfaces__srv__MapPointCloud2_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ipm_interfaces
...
/**
 * It calls
 * ipm_interfaces__srv__MapPointCloud2_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ipm_interfaces
...
/**
 * It calls
 * ipm_interfaces__srv__MapPointCloud2_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * ipm_interfaces__srv__MapPointCloud2_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_ipm_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ipm_interfaces__srv__MapPointCloud2_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ipm_interfaces
...
/**
 * It calls
 * ipm_interfaces__srv__MapPointCloud2_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ipm_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ipm_interfaces__srv__MapPointCloud2_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ipm_interfaces
...
/**
 * It calls
 * ipm_interfaces__srv__MapPointCloud2_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IPM_INTERFACES__SRV__DETAIL__MAP_POINT_CLOUD2__FUNCTIONS_H_
