...
bool vision_msgs__msg__classification__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._classification.Classification", full_classname_dest, 46) == 0);
  }
  vision_msgs__msg__Classification * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Classification */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._classification");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Classification");
